...
Record Class
^^^^^^^^^^^^^^
.. autoclass:: hyperdns.netdns.recordclass.RecordClass
    :members:
    :inherited-members:
    :undoc-members:
    :show-inheritance:
...
Record Type
^^^^^^^^^^^^^^
.. autoclass:: hyperdns.netdns.recordtype.RecordType
    :members:
    :inherited-members:
    :undoc-members:
    :show-inheritance:

Op Codes and Response Codes
^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. automodule:: hyperdns.netdns.querycodes
    :members:
    :inherited-members:
    :undoc-members:
    :show-inheritance:
