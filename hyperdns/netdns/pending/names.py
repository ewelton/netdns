...
PEP8_INDICATION="PEP8 prefers function and method names with underscores and not camelcase.  CamelCase is preferred for classes.  See https://www.python.org/dev/peps/pep-0008/"
...
def splitFqdn(fqdn):
    """Deprecated - see PEP8
    """
    print(PEP8_INDICATION)
    return split_fqdn(fqdn)
...
def REMOVE_ME_I_DONT_THINK_I_AM_USED_ANYMORE_fqdn(name,zone=None):
